...
export const currentteam = [
  ...
  },
  {
    ...
    image: "sathvik.png",
    bio: "As the Technical Head of our club, I take pride in overseeing the end-to-end execution of all technical initiatives. My role is to lead our tech team with vision and strategy—ensuring that every project we undertake is not only innovative but also efficient and impactful. I focus on aligning technical goals with the club’s broader mission, mentoring fellow tech enthusiasts, and promoting a culture of continuous learning. Whether it’s designing systems, solving complex problems, or exploring new technologies, I strive to set high standards and drive excellence. Together, we build solutions that reflect our skills, teamwork, and ambition."
  },
  {
    name: "Varun Sai",
    role: "Event Organising head",
  ...
  2024: [
    {
      ...
      bio: "Reflecting on my tenure as Chairperson of the club, I am proud of the growth and accomplishments we achieved together. Leading such a passionate and talented team was a rewarding experience that taught me the value of collaboration, resilience, and vision. I am grateful for the opportunity to have guided initiatives that strengthened our community and created lasting impact. Though my term has ended, I remain deeply connected to the club’s mission and look forward to seeing it thrive under new leadership. It’s an honor to have contributed to a foundation that inspires future members to lead with purpose."
    },
    {
      name: "Vipin Rangu",
      role: "President",
      ...
      bio: "Serving as the President of our club was an incredibly fulfilling journey that allowed me to lead with purpose and passion. Throughout my tenure, I focused on fostering teamwork, encouraging innovation, and driving impactful initiatives that aligned with our club’s vision. The experience strengthened my leadership skills and deepened my commitment to our community. Though my presidency has concluded, I remain proud of what we accomplished together and continue to support the club’s ongoing growth. It’s been an honor to have been part of such a dedicated team, and I’m excited to see the club reach new heights in the future."
    },
    {
      ...
      bio: "Serving as the Treasurer of our club was a valuable and enriching experience. I was entrusted with managing the club’s finances responsibly, ensuring transparency and efficient use of resources to support our initiatives. This role helped me develop strong organizational and financial skills, as well as a deep appreciation for teamwork and accountability. Though my term has ended, I remain proud of the financial foundation we built and confident that the club will continue to grow sustainably. It was an honor to contribute to the club’s success, and I look forward to seeing it flourish in the years ahead."
    },

    {
      ...
      bio: "Serving as the General Secretary of our club was an enriching and rewarding experience. I was responsible for coordinating communication, organizing meetings, and ensuring smooth workflow among members. This role taught me the importance of effective communication, organization, and leadership in driving a team toward common goals. Although my tenure has concluded, I am proud of the collaborative spirit and achievements we fostered during my time. I remain supportive of the club’s mission and excited to see the continued growth and success under new leadership. It was an honor to serve and contribute to such a dynamic team."
    },
    {
      name: "Rishith",
    ...
    },
    {
      ...
      bio: "Reflecting on my time as a Student Coordinator, I am grateful for the opportunity to serve and support our vibrant club community. My role involved bridging communication between students and faculty, assisting in event planning, and ensuring smooth coordination among members. This experience enhanced my leadership and organizational skills while fostering a strong sense of teamwork. Although my term has concluded, I take pride in the positive impact we made together and the inclusive environment we nurtured. I remain enthusiastic about the club’s future and confident that it will continue to thrive with new leaders at the helm."
    },
    {
      name: "Sindhu Priya",
      role: "Student cooordinator",
    ...
    },
    {
      ...
      bio: "Serving as the Design Team Head was an incredible experience that allowed me to lead creative projects and shape the visual identity of our club. I oversaw the design process for event materials, social media content, and branding initiatives, ensuring consistency and quality. This role helped me grow both as a designer and a leader, fostering collaboration and innovation within the team. Though my term has ended, I take pride in the creative legacy we built and am confident that the design team will continue to elevate the club’s presence. It was an honor to contribute to such a vibrant community."
    },
    {
      name: "Akshaya Gampa",
      role: "Design head",
      ...
      bio: "Reflecting on my time as Design Team Head, I’m proud to have guided a talented group of creatives in delivering impactful and cohesive visual content for the club. Leading the team involved brainstorming innovative ideas, managing deadlines, and maintaining the club’s branding standards across all platforms. This role enhanced my skills in leadership, creativity, and project management. Even though my tenure has concluded, I cherish the collaborative spirit we cultivated and the lasting impression our designs have made. I’m excited to see the design team continue to thrive and push creative boundaries in the future."
    },
    {
      name: "Akanksha",
      role: "Design head",
      ...
      bio: "Serving as the Design Head was a truly rewarding experience where I had the privilege to lead and inspire a creative team dedicated to enhancing the club’s visual presence. I worked closely with members to craft designs that effectively communicated our message and energized our events. This role sharpened my artistic vision, leadership abilities, and teamwork skills. Although my term has ended, I’m proud of the innovative designs we produced and the strong foundation we laid for future creative efforts. It’s been an honor to contribute to a club that values creativity as a core strength."
    },
    {
      name: "Roshini Reddy",
      role: "Documentation",
    ...
    },
    {
      ...
      bio: "Reflecting on my time as Documentation Head, I’m proud to have played a key role in capturing and organizing the club’s important milestones and day-to-day activities. My responsibilities included maintaining accurate records, preparing detailed minutes, and ensuring smooth communication within the team. This role enhanced my attention to detail, writing skills, and ability to manage information effectively. Though my term has concluded, I’m grateful for the opportunity to preserve the club’s legacy and support its continued progress. I look forward to seeing the club grow and thrive under new leadership and fresh ideas."
    },

    {
      ...
      bio: "During my time as a Student Coordinator, I had the privilege to support and engage with fellow members, helping to organize events and facilitate communication between students and the leadership team. This role strengthened my organizational and interpersonal skills, allowing me to contribute to the club’s smooth functioning and vibrant community. Although my term has ended, I cherish the relationships built and the collective achievements we accomplished. I am proud to have played a part in nurturing an inclusive environment where everyone’s voice mattered, and I look forward to seeing the club continue to inspire and empower future students."
    },
    {
      name: "Hansika",
      role: "Event organizer",
    ...
    },
    {
      ...
      bio: "Serving as a Student Coordinator was an enriching experience that allowed me to actively contribute to the club’s vibrant activities and member engagement. I took pride in organizing events, facilitating communication, and ensuring smooth coordination between students and the leadership team. This role helped me develop essential skills in teamwork, leadership, and time management. Even though my term has ended, I cherish the meaningful connections made and the collective growth we achieved. I remain a proud supporter of the club’s mission and look forward to seeing future leaders build on our foundation."
    },
    {
      name: "Varshith",
      role: "Event organizer",
      ...
      bio: "Looking back on my time as a Student Coordinator, I’m grateful for the chance to contribute to our club’s vibrant community. I was responsible for facilitating communication among members, assisting with event planning, and ensuring smooth collaboration between students and the leadership team. This role enhanced my organizational and leadership skills, and taught me the value of teamwork and adaptability. Although my term has ended, I’m proud of the positive impact we made together and remain enthusiastic about the club’s bright future. It was an honor to serve and support such a dedicated group."
    },
    {
      name: "Sree Keerthi",
      role: "PR head",
      ...
      bio: "Serving as the PR Head was a rewarding experience that allowed me to represent and promote our club’s activities to a wider audience. I managed communications, crafted press releases, and built relationships with media and partners to enhance the club’s visibility. This role helped me develop skills in strategic communication, networking, and brand management. Although my term has ended, I take pride in the positive image we created and the increased engagement we achieved. I’m grateful for the opportunity to have contributed to the club’s growth and look forward to its continued success under new leadership."
    },
    {
      name: "Chandana",
      role: "PR head",
    ...
    },
    {
      ...
      bio: "During my time as PR Head, I had the privilege of amplifying our club’s voice and fostering meaningful connections with both internal members and external audiences. I was responsible for managing our public communications, crafting compelling content, and coordinating outreach efforts to maximize engagement. This role sharpened my communication, strategic planning, and relationship-building skills. Although my term has ended, I am proud of the stronger presence we established and the positive reputation we built for the club. I remain excited to see the club continue to grow and make an impact in the future."
    },
    {
      name: "Sai Prajwal",
      role: "PR head",
      ...
      bio: "Serving as the PR Head was a remarkable experience that allowed me to enhance the visibility and reputation of our club. I focused on developing strategic communication plans, engaging with media partners, and creating content that resonated with our audience. This role helped me grow my skills in public relations, marketing, and teamwork. Though my term has ended, I am proud of the strong connections and positive image we built together. It was an honor to contribute to the club’s mission and I look forward to seeing the continued success and growth of the organization."
    },
    {
      name: "Anirudh",
      role: "Technical head",
    ...
    },
    {
      ...
      bio: "Reflecting on my time as Technical Head, I’m proud to have led the club’s technological efforts, driving innovation and ensuring reliable support for all projects. I coordinated the development and maintenance of technical systems, collaborated closely with team members, and resolved challenges to keep everything running smoothly. This role enhanced my skills in leadership, teamwork, and problem-solving within a fast-paced environment. Though my term has ended, I take pride in the achievements we accomplished and the strong technical foundation laid for the club’s future. I am excited to see the continued growth and success of the technical team."
    },
    {
      name: "Rohith",
      role: "Technical head",
      ...
      bio: "Serving as Technical Head was a highly rewarding experience that allowed me to lead the club’s tech initiatives and support its digital growth. I was responsible for overseeing technical projects, guiding team members, and ensuring efficient problem-solving during events and development phases. This role helped me refine my technical expertise, leadership, and collaboration skills. Although my term has concluded, I am proud of the innovative solutions we delivered and the solid groundwork we established. I look forward to witnessing the club’s continued technological advancements and successes under new leadership."
    },
    {
      name: "Avinash",
      role: "Technical head",
      ...
      bio: "Reflecting on my tenure as Technical Head, I am grateful for the opportunity to lead and inspire the club’s technical team. My role involved coordinating development efforts, troubleshooting technical challenges, and ensuring the successful execution of projects that advanced the club’s mission. This experience strengthened my leadership, communication, and problem-solving skills. Though my term has ended, I take pride in the innovations we introduced and the collaborative spirit we fostered. I look forward to seeing the technical team continue to thrive and push the boundaries of what the club can achieve."
    },

    {
      ...
      bio: "Serving as the Social Media Head was an exciting opportunity to enhance the club’s online presence and engage with our community across various platforms. I was responsible for creating and curating content, managing social campaigns, and analyzing engagement metrics to optimize our reach. This role helped me develop skills in digital marketing, content strategy, and audience engagement. Though my term has ended, I’m proud of the vibrant online community we built and the increased visibility we achieved for the club’s events and initiatives. It was a privilege to contribute to the club’s growth through creative storytelling and outreach."
    },
    {
      name: "Vedasri Gunti",
      role: "Social media head",
      ...
      bio: "Reflecting on my time as Social Media Head, I’m proud to have played a key role in shaping the club’s digital identity and outreach. I managed content creation, scheduling, and engagement across multiple platforms to ensure consistent and compelling communication with our audience. This role enhanced my skills in digital marketing, creativity, and analytics. Although my term has ended, I’m proud of the growth in our online community and the increased awareness of the club’s activities. It was a rewarding experience to connect with members and supporters through meaningful and engaging content."
    },

    {
      ...
      bio: "Serving as the Social Media Head allowed me to connect our club with a wider audience and create an engaging digital presence. I was responsible for planning and executing social media strategies, producing creative content, and fostering interaction across platforms. This role sharpened my skills in communication, marketing, and teamwork. Even though my term has ended, I’m proud of the strong online community we built and the positive impact our digital outreach had on the club’s visibility and engagement. It was an honor to contribute to the club’s growth through innovative and consistent social media efforts."
    },
    {
      ...
      bio: "Serving as the Event Coverage and Editing Head was a rewarding experience where I had the opportunity to capture and showcase the club’s vibrant activities. I managed photography, videography, and editing to create engaging content that highlighted our events and achievements. This role enhanced my technical skills in media production, storytelling, and project management. Although my term has ended, I’m proud of the dynamic visual records we produced, which continue to inspire and engage our members and audience. It was an honor to contribute to preserving the club’s legacy through creative and impactful media."
    },
    {
      name: "Prashanthi",
      role: "Event Coverage/Editing",
      ...
      bio: "Reflecting on my time as Event Coverage and Editing Head, I’m grateful for the chance to document our club’s exciting events and bring them to life through photography and video editing. I worked closely with the team to capture memorable moments and craft compelling visual stories that showcased the club’s spirit. This role helped me develop my creative and technical skills while supporting the club’s communication efforts. Though my term has ended, I take pride in the lasting impact of our work and the way it continues to connect and inspire the community."
    },
    {
      name: "Rama Devi",
      role: "Event Coverage/Editing",
      ...
      bio: "Serving as the Event Coverage and Editing Head was an incredible opportunity to visually capture the energy and essence of our club’s events. I was responsible for recording, editing, and presenting media content that reflected our achievements and camaraderie. This role allowed me to hone my skills in videography, photography, and post-production while contributing to the club’s storytelling efforts. Although my term has ended, I’m proud of the creative work we delivered and how it helped promote our club’s vibrant culture. It was truly fulfilling to help preserve these memorable moments for the community."
    }
  ],
}
